    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-auto">
                    <a href="/pengetahuan/create" class="btn secondary-bg text-white mt-3 p-2 fw-bold">
            ...
            <div class="row my-3">
                <div class="col-md table-responsive">
                            ...
                            <?php else : ?>
                                ...
                                <?php foreach ($pengetahuan as $pt) : ?>
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="/pengetahuan/edit/<?= $pt['id_pengetahuan']; ?>" class="btn yellow-bg text-white fw-bold">
                    ...
                    <?= $pager->links('pengetahuan', 'custom_pagination'); ?>
                </div>
            </div>
        </div>
    </div>
