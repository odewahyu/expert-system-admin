    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-auto">
                    <a href="/gejala/create" class="btn secondary-bg text-white mt-3 p-2 fw-bold">
                ...
                <div class="col-md table-responsive">
                    <table class="table table-hover bg-white rounded-2 shadow-sm">
                        ...
                        <tbody>
                            <?php if ($jumlah == 0) : ?>
                                <tr>
                                    <td colspan="5" class="text-center fw-bold"><?= $msg; ?></td>
                                </tr>
                            <?php else : ?>
                                ...
                                <?php foreach ($gejala as $g) : ?>
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="/gejala/edit/<?= $g['kode_gejala']; ?>" class="btn yellow-bg text-white fw-bold">
                    ...
                    <?= $pager->links('gejala', 'custom_pagination'); ?>
                </div>
            </div>
        </div>
    </div>
